        ...
        <Flex h='calc(100vh)' width="full">
            <Box h="full" flex="1" background="#0485FF" maxH="max-content" >
                <Flex h='calc(100vh)' flexDirection="column" alignItems="center" justifyContent="flex-end">
                    ...
                    <Box background="#00CC99" height="198px" color="white" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                        <Heading alignItems="center" paddingX="20" as='h1' fontSize="35px" fontWeight="bold">Junte-se a vários clientes satisfeitos.</Heading>
            ...
            <Box h="full" flex="1" background="white" >
                <Flex h='calc(100vh)' flexDirection="column" alignItems="center" justifyContent="center">
                    ...
                    <VStack as="form" alignItems="flex-start" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Button type="submit" title="Logar" background="#0385FD" width="400px" height="60px" color="white" borderRadius="5px" textTransform="uppercase" fontWeight="bold"/>

                        <Button title="Criar Conta" background="#00CC99" width="400px" height="60px" color="white" borderRadius="5px" textTransform="uppercase" mt="136px" fontWeight="bold"/>
                    </VStack>
                </Flex>
            </Box>
        </Flex>
